-- ==========================================
-- YakuSabor — Script de base de datos
-- Ejecutar completo en cualquier PC nueva
-- ==========================================

DROP DATABASE IF EXISTS yaku_sabores;
CREATE DATABASE yaku_sabores CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE yaku_sabores;
...
-- Tabla intermedia para saber qué insumos gasta cada producto de la carta
...
INSERT INTO usuarios (id, nombre, email, password_hash, rol_id, activo) VALUES
    (1, 'Juan Pérez', 'juan.perez@mail.com', '$2a$12$vBRY6MCQkShYZEsIXWotIeEhBUBffuoYdu/lGGvkcxQBzr0VC6YmS', 1, TRUE),
    (2, 'María López', 'maria.lopez@mail.com', '$2a$12$unWgIrDrXr/Np.A5KfGCZO78jhgAcjYOP4G4PllrLMcmRAII7ooz6', 2, TRUE),
    (3, 'Carlos Ramírez', 'carlos.ramirez@mail.com', '$2a$12$/V2TLBWgDIiuJDbtioitp.0m6Tti5M/TfP8s3Kehhq0tvxDm/g5.O', 3, TRUE),
    (4, 'Ana Torres', 'ana.torres@mail.com', '$2a$12$CoNnAFg2SLQ..3dgoQr4qOQG9INbL.ZPNz4ZKMAMb/hZmT6O.EOyy', 4, TRUE);
